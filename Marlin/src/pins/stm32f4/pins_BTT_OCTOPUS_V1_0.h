...
#define M_DIAG_PIN                         PG14  // E2DET
#define O_DIAG_PIN                         PG15  // E3DET
...
#define M_STEP_PIN                         PE2   // MOTOR 6
#define M_DIR_PIN                          PE3
#define M_ENABLE_PIN                       PD4
#ifndef M_CS_PIN
  #define M_CS_PIN                         PE1
#endif

#define O_STEP_PIN                         PE6   // MOTOR 7
#define O_DIR_PIN                          PA14
#define O_ENABLE_PIN                       PE0
#ifndef O_CS_PIN
  #define O_CS_PIN                         PD3
#endif

#define E0_STEP_PIN                         PG12
#define E0_DIR_PIN                          PG13
...
//
  ...
  #define I_SERIAL_RX_PIN                  PC7

  #define J_SERIAL_TX_PIN                  PF2
  #define J_SERIAL_RX_PIN                  PF2

  #define K_SERIAL_TX_PIN                  PE4
  #define K_SERIAL_RX_PIN                  PE4

  #define M_SERIAL_TX_PIN                  PE1
  #define M_SERIAL_RX_PIN                  PE1

  #define O_SERIAL_TX_PIN                  PD3
  #define O_SERIAL_RX_PIN                  PD3
