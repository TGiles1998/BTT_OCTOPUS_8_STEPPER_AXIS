 ...
 */
  ...
  static void tmc_debug_loop(
    ...
    LOGICAL_AXIS_LIST(const bool print_x, const bool print_y, const bool print_z, const bool print_i, const bool print_j, const bool print_k, const bool print_m, const bool print_o, const bool print_p, const bool print_q)
  ) {
